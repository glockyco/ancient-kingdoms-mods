---
name: edit-claude-md
description: Guidelines for writing and editing CLAUDE.md files in this repository
---
...
- `mods/CLAUDE.md` - Mods subproject
- `build-pipeline/CLAUDE.md` - Python pipeline
- `website/CLAUDE.md` - SvelteKit site
- `website/src/lib/map/CLAUDE.md` - Map component
