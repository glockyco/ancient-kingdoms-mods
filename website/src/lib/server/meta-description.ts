...
function scrollDescription(item: Item): string {
  ...
  // Source: server-scripts/ScrollItem.cs:101,93 — spell rank scales with player.scrollMasteryLevel
...
export function skillDescription(skill: SkillDescriptionInput): string {
  ...
  // Source: server-scripts/PlayerSkills.cs:1464-1466 — veteran upgrades check
