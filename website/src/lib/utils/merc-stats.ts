...
// Source: server-scripts/Player.cs:9497-9509 — each veteran point adds +0.25% to Health and Mana multipliers.
...
// Source: server-scripts/Player.cs:9426-9455 — per-race roll bands and base-combat factors.
...
// Source: server-scripts/Player.cs:7975-8011,8012-8040,8041-8069,8070-8098,8099-8127,8128-8159 — per-class attribute divisors.
...
// Source: server-scripts/Player.cs:7975-8011,8012-8040,8041-8069,8070-8098,8099-8127,8128-8159 — mercenary attributes are floor(level / class divisor).
...
// Source: server-scripts/Constitution.cs:13-15, server-scripts/Player.cs:9482-9499 — Health curve times multiplier plus Constitution.
const hpAt = (hpCurve: number, mult: number, con: number): number =>
  iround(f32(f32(hpCurve) * f32(mult))) + con * CON_HEALTH;
// Source: server-scripts/Intelligence.cs:21-23, server-scripts/Player.cs:9482-9509 — Mana curve times multiplier plus Intelligence.
const manaAt = (manaCurve: number, mult: number, intl: number): number =>
  iround(f32(f32(manaCurve) * f32(mult))) + intl * INT_MANA;
// Source: server-scripts/Player.cs:9426-9455 — base-combat max is round(level × race factor) − 1.
...
/** Source: server-scripts/Player.cs:9696-9700,9702-9732,9758-9770 — hire rolls race, multipliers, and shared base-combat value. */
/** Source: server-scripts/Player.cs:9482-9509 — summoned mercenaries apply level, veteran points, Health, Mana, Attack Power, and Spell Power. */
/** Source: server-scripts/Player.cs:7975-8011,8012-8040,8041-8069,8070-8098,8099-8127,8128-8159 — class attributes are rebuilt from level. */
