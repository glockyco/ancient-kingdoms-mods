...
export function formatGatheringRespawn(
  ...
  // Source: server-scripts/GatherItem.cs:239,332,603 — Random.Range(100f, 3600f)
  if (type === "gathering_spark" || type === "Radiant Spark") {
    return "1m40s – 1h";
  }
  // Source: server-scripts/GatherItem.cs:330,812 — Random.Range(timeToWaitReady / 2f, timeToWaitReady)
