...
// Source: server-scripts/Player.cs:12843-12846 and TableUI.cs:92 — an alchemy/scribing
...
// Source: server-scripts/Utils.cs:533-543 — GetSuccessProbAlchemy(levelPotion,
...
// Source: server-scripts/Player.cs:12869-12873 — a high enough Alchemy skill turns
...
// Source: server-scripts/Player.cs:12873 — skill gain fires when
...
// Source: server-scripts/Player.cs:12875 — num4 = Random.Range(1, 4) /
