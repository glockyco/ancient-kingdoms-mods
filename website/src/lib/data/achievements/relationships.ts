...
// Source: server-scripts/Player.cs:9765-9777 — these quest names unlock the two achievement IDs.
...
// Source: server-scripts/Player.cs:10003-10032 — each monster name maps directly to one achievement ID.
