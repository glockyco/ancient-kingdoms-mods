...
// Source: server-scripts/Player.cs:11225-11237 — these quest names unlock the two achievement IDs.
...
// Source: server-scripts/Player.cs:11447-11476 — each monster name maps directly to one achievement ID.
