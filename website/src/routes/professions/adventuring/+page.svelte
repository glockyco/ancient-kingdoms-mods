<script lang="ts">
  ...
  // Source: server-scripts/Utils.cs:GetDailyAdventurerQuest — adventurer quest selection is seeded by DateTime.UtcNow.DayOfYear, so UTC midnight starts a new queue day.
  ...
  // Source: server-scripts/Utils.cs:609-625 — adventurer quest order uses Unity/Mono's seeded System.Random with a Fisher-Yates shuffle.
    ...
    <div class="mt-4 divide-y">
      ...
      <div class="grid gap-3 py-4 md:grid-cols-[2rem_1fr]">
        ...
        <div>
          ...
          <p class="mt-1 text-sm leading-6 text-muted-foreground">
            <!-- Source: server-scripts/Utils.cs:596-601 — the daily offer requires a recommended level at or below the character level and no completion in the last 24 hours. -->
