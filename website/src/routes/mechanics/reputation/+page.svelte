...
<div class="container mx-auto max-w-5xl space-y-8 p-8">
  ...
  <Card.Root id="pets" class="bg-muted/30">
    ...
    <Card.Content class="space-y-4 text-sm text-muted-foreground">
      ...
      <!-- Source: server-scripts/Player.cs:12777-12781 — CmdIncreaseFaction adds the value unchanged. -->
      <p>
  ...
  <Card.Root id="decay" class="bg-muted/30">
    ...
    <Card.Content class="space-y-4 text-sm text-muted-foreground">
      ...
      <!-- Source: server-scripts/Player.cs:12777-12781, Monster.cs:2751-2763, Npc.cs:1606-1616, PlayerQuests.cs:440-443, GatherItem.cs:336-344 — every write adds or subtracts without clamping. -->
