...
static Dictionary<string, object?> SpriteRef(string entityId, string entityName, string visualKind, string sourceField, Sprite sprite)
{
    return new Dictionary<string, object?>
    {
        ...
        ["runtime_image_path"] = WriteSpriteImage(sprite, "pet", entityId, visualKind, sourceField),
...
static Dictionary<string, object?> SpriteRendererRef(string entityId, string entityName, string visualKind, string sourceField, SpriteRenderer renderer)
{
    ...
    return new Dictionary<string, object?>
    {
        ...
        ["runtime_image_path"] = sprite != null ? WriteSpriteImage(sprite, "pet", entityId, visualKind, sourceField + "." + renderer.name) : null,
...
foreach (var obj in Resources.FindObjectsOfTypeAll(petType))
{
    ...
    {
        rows.Add(SpriteRef(entityId, entityName, "icon", "Pet.portraitIcon", pet.portraitIcon));
    }
    ...
    if (pet.gameObject != null)
    {
        ...
        {
            rows.Add(SpriteRendererRef(entityId, entityName, "renderer", "Pet.gameObject.SpriteRenderer", renderer));
        }
    }
}
