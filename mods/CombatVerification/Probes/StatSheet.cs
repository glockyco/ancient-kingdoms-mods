            ...
            IReadOnlyList<ItemSlot> slots)
        {
            ...
            return new EntitySheet
            {
                ...
                Resources = new ResourceSheet
                {
                    ...
                    HealthRecoveryRate = health.recoveryRate,
                    HealthMultiplier = health.multiplierHealth,
                    ManaMax = mana.max,
                    ManaRecoveryRate = mana.recoveryRate,
                    ManaMultiplier = mana.multiplierMana,
                    EnergyMax = energy.max,
                    EnergyRecoveryRate = energy.recoveryRate,
                    EnergyMultiplier = energy.multiplierEnergy,
                },
