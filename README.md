...
| Mod                 | Summary                                                                                                                                                                                                            |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `BestiaryRevealer`  | Reveals selected Bestiary monster details, lore, stats, and loot tooltips without changing actual discovery or kill progress. Optional scanner can add loaded missing boss, elite, and fabled entries at runtime. |
