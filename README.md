...
| Mod                 | Summary                                                                                                                                                                                                            |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `BestiaryRevealer`  | Reveals Bestiary monster details, lore, stats, and loot tooltips without changing actual discovery or kill progress. Alt-left-click a monster to open its Bestiary page directly. Optional scanner can add loaded missing boss, elite, and fabled entries at runtime. |
