...
- Source: server-scripts/GatherItem.cs:572-581 — gathering EXP by tier
- Source: server-scripts/Player.cs:13130-13136 — crafting EXP by item quality
- Source: server-scripts/Player.cs:11357-11364 — alchemy EXP by recipe tier
"""
