    ...
    for pet in pets:
        cursor.execute(
            """INSERT INTO pets (
                ...
                magic_resist_base, magic_resist_per_level,
                poison_resist_base, poison_resist_per_level,
                fire_resist_base, fire_resist_per_level,
                cold_resist_base, cold_resist_per_level,
                disease_resist_base, disease_resist_per_level,
            ...
            (
                ...
                pet.magic_damage_per_level,
                pet.defense_base,
                pet.defense_per_level,
                pet.magic_resist_base,
                pet.magic_resist_per_level,
                pet.poison_resist_base,
                pet.poison_resist_per_level,
                pet.fire_resist_base,
                pet.fire_resist_per_level,
                pet.cold_resist_base,
                pet.cold_resist_per_level,
                pet.disease_resist_base,
                pet.disease_resist_per_level,
                pet.block_chance_base,
                pet.block_chance_per_level,
                pet.critical_chance_base,
                pet.critical_chance_per_level,
            ),
        )
